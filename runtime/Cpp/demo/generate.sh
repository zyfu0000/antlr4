...
LOCATION=antlr4-4.8-2-SNAPSHOT-complete.jar
java -jar $LOCATION -Dlanguage=Cpp -listener -visitor -o generated/ -package antlrcpptest ObjectiveCLexer.g4 ObjectiveCParser.g4 ObjectiveCPreprocessorParser.g4
